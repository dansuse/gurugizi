...
<div id="container">
	...
	<?php
		...
		echo '<p>';
		echo 'Jumlah Data Nutritionist Per-Halaman : ';
		...
		foreach($nutritionist as $p)
		{
			...
			echo '</p>';
			echo '<p> CV : ';
			echo '<a href="'.site_url('c_laporan/downloadFileAkademik/CV/'.$p->file_cv).'" target="_blank">Download File</a>';
			echo '</p>';
			echo '<p> Transkrip Nilai : ';
			echo '<a href="'.site_url('c_laporan/downloadFileAkademik/Transkrip Nilai/'.$p->file_transkrip_nilai).'" target="_blank">Download File</a>';
			echo '</p>';
			echo '<p> Ijazah : ';
			echo '<a href="'.site_url('c_laporan/downloadFileAkademik/Ijazah/'.$p->file_ijazah).'" target="_blank">Download File</a>';
			echo '</p>';
			echo '<p> Str : ';
			echo '<a href="'.site_url('c_laporan/downloadFileAkademik/Str/'.$p->file_str).'" target="_blank">Download File</a>';
			echo '</p>';
			echo '<p > Keterangan : ';
			echo $p->keterangan;
