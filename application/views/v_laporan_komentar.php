...
<div id="container">
	...
	<?php
		...
		echo '<H1>Laporan Komentar Pasien '.$pasien->nama.'</H1>';
		...
		echo '</p>';
		echo '<p>';
		echo form_submit('btnRefreshKomentar','Refresh');
		echo '</p>';
		echo '<hr>';
		...
		foreach($comment as $c)
		{
			...
			echo $c->isi_comment;
			echo '</p>';
			echo '<p><b>Tanggal Komentar : </b>';
			echo $c->waktu_comment;
			echo '</p>';
			
			$convertEmail = str_replace("@", ':', $c->email_pasien);
			echo '<p>';
			echo '<a style="text-decoration:none; color:black;" href = "'.site_url('c_laporan/deleteKomentar/'.$convertEmail.'/'.$c->id_comment).'"><input type = "button" value = "Hapus Komentar">'.'</input></a>';
			echo '</p>';
